...
#'
#' @param data The data that needs to be quantized. Useful only if cell_numbers == NULL and outputs_function == NULL.
...
std_proba = function(data = NULL, prototypes_list, density_ratio, distance_func = function(A1,A2){return(sqrt(sum((A1-A2)^2)))},cells, cell_numbers = NULL, nv, outputs_function = NULL, inputs = NULL, batch_size = NULL, return_cell_numbers = FALSE){
