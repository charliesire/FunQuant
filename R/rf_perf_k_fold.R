...
#'
#' @examples
rf_rmse_k_fold = function(x, outputs, threshold, list_search, nb_folds, return_pred = FALSE, seed = NULL, ncoeff,npc, formula = ~1, covtype="matern5_2",boundary = "periodic",J=1,
  ...
  return(list(maps_rmse = maps_rmse, outputs_pred = outputs_pred))
}
